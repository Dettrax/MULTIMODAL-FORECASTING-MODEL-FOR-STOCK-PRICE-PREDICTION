...
checker.insert(5, 'Price', price)


lt_delta.insert(5, 'Lt', Lt)
...
def run_xgb(merge_data,lookback, n_estimators=20):
    ...
    train_x, train_y, test_x, test_y, delta_x, delta_y, checker_x, checker_y = prep_data(train, test, lt_delta, checker, lookback)
    y, yhat = walk_forward_validation(train_x, test_x, test_y, n_estimators)
    # y,yhat
    # return evaluation_metric(y,yhat)


# R2 = optimise_loookback(train, test, lt_delta, checker, 17, 12)
# print(R2)
# MSE: 2.08595
# RMSE: 1.44428
# MAE: 1.14214
